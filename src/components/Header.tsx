...
const Header = ({ busCount, districtName }: HeaderProps) => {
  return (
    <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-4 sm:px-5 py-3 bg-primary text-primary-foreground shadow-lg">
